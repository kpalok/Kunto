    ...
    class Program
    {
        ...
        private static void CalcSingleFile(string path)
        {
            ...
            for (a = 0; a < 26; a++)
            {
                ...
                WriteLine($"x:{xAvg} y:{yAvg} z:{zAvg} z var:{zVari}");

                //Lift Up
                if ((0.0011 <= zVari && zVari < 0.009) || (zAvg <= -0.992 && xAvg < -0.0001))
                {
                    WriteLine($"Lift Up");
                }
                //Lift Down
                else if ((0.0003 <= zVari && zVari <= 0.0011) || (-0.99 < zAvg && zAvg < -0.92 && yAvg < 0 && 0.0002 < zVari && zVari < 0.003))
                {
                    WriteLine($"Lift Down");
                }
                //Stairs
                ...
                //Idle
                else if (zVari < 0.0003 || (zVari < 0.0003 && -1.0 < zAvg && zAvg < -0.98))
                {
                    WriteLine($"Idle");
                }
            }
